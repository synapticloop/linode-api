...
public class LinodeApi {
	 ...
	 *
	 * @return the parsed NodebalancerNodeCreateResponse response object
	 *
	 * @throws ApiException if a required parameter is null, or there was an error with the call
	 */
	public NodebalancerNodeCreateResponse getNodebalancerNodeCreate(Long configID, String label, String address) throws ApiException {
		return(new NodebalancerNodeCreateResponse(execute(NodebalancerRequest.nodecreate(configID, label, address)).getJSON()));
	}
	 ...
	 * @throws ApiException if a required parameter is null, or there is an error with the call
	 */
	public NodebalancerNodeCreateResponse getNodebalancerNodeCreate(Long configID, String label, String address, Long weight, String mode) throws ApiException {
		return(new NodebalancerNodeCreateResponse(execute(NodebalancerRequest.nodecreate(configID, label, address, weight, mode)).getJSON()));
	}
	 ...
	 *
	 * @return the parsed NodebalancerNodeDeleteResponse response object
	 *
	 * @throws ApiException if a required parameter is null, or there was an error with the call
	 */
	public NodebalancerNodeDeleteResponse getNodebalancerNodeDelete(Long nodeID) throws ApiException {
		return(new NodebalancerNodeDeleteResponse(execute(NodebalancerRequest.nodedelete(nodeID)).getJSON()));
	}
	 ...
	 *
	 * @return the parsed NodebalancerNodeUpdateResponse response object
	 *
	 * @throws ApiException if a required parameter is null, or there was an error with the call
	 */
	public NodebalancerNodeUpdateResponse getNodebalancerNodeUpdate(Long nodeID) throws ApiException {
		return(new NodebalancerNodeUpdateResponse(execute(NodebalancerRequest.nodeupdate(nodeID)).getJSON()));
	}
	 ...
	 * @throws ApiException if a required parameter is null, or there is an error with the call
	 */
	public NodebalancerNodeUpdateResponse getNodebalancerNodeUpdate(Long nodeID, String label, String address, Long weight, String mode) throws ApiException {
		return(new NodebalancerNodeUpdateResponse(execute(NodebalancerRequest.nodeupdate(nodeID, label, address, weight, mode)).getJSON()));
	}

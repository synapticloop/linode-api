...
<html lang="en">
	<head>
		...
		<title>linode.boot() - Linode API</title>
...
<section class="white doc">
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				<h1 class="h2">linode.boot()</h1>
				<p>Issues a boot job for the provided ConfigID.  If no ConfigID is provided boots the last used configuration profile, or the first configuration profile if this Linode has never been booted.</p>
					...
					<ul class="api-params">
							...
							<li><strong>ConfigID</strong> - numeric (optional) 
									<small>The ConfigID to boot, available from linode.config.list().</small>
   ...
   "DATA":{
      "JobID":1293
				...
				<h3>Errors</h3>
					...
					<p><code class='api-error'>NOTFOUND</code></p>
						...
						<div class="row">
							...
							<div class="footer-col">
								...
								<ul>
									...
									<li><a href="/sponsorships">Supported Projects</a></li>
